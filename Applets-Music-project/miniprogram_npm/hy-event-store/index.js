...
__DEFINE__(1684307141683, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1684307141684,"./event-store":1684307141685}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1684307141684, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1684307141685, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1684307141684,"./utils":1684307141686}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1684307141686, function(require, module, exports) {
...
return __REQUIRE__(1684307141683);
})()
