...
__DEFINE__(1677123804644, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1677123804645,"./event-store":1677123804646}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1677123804645, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1677123804646, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1677123804645,"./utils":1677123804647}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1677123804647, function(require, module, exports) {
...
return __REQUIRE__(1677123804644);
})()
